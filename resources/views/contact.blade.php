        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="space-y-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex-1 text-gray-700 ml-4">營業時間：週一至週五 9:00-18:00</div>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex-1 text-gray-700 ml-4">{{ $contact['data']['address'] }}</div>
                </div>
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex-1 text-gray-700 ml-4">{{ $contact['data']['phone'] }}</div>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex-1 text-gray-700 ml-4">{{ $contact['data']['fax'] }}</div>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex-1 text-gray-700 ml-4">{{ $contact['data']['email'] }}</div>
                    </div>
                </div>
            </div>
        </div>
